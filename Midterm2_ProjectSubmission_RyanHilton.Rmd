...
```{r, dpi=250, out.height='85%', echo=FALSE}
...
```{r}
set.seed(99)
neurons = 1 #best number of first hidden layer neurons (produced most consistently low mse values)
neurons2 = 4 # sqrt(predictors) seems reasonable considering the choice of second hidden layer neurons didn't seem to play a big role in mse values with 1 first hidden layer neuron
